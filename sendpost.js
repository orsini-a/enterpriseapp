...
{
  var obj=new upSta();
  obj["id_user"]=sessionStorage.getItem("id");//f.uid.value;//f.pseudo.value; // document.getElementById('nom').value
  obj["content"]=f.upstatu.value;//f.uid.value;//f.pseudo.value; // document.getElementById('nom').value
